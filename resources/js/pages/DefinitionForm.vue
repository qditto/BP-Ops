            ...
            <div class="card-body">
                <form @submit.prevent="onSubmit">
                    ...
                    <b-form-group label="Field Group">
                        <multiselect v-model="form.field_group_id" :options="field_groups" label="name" track-by="name" />
                    </b-form-group>
                    <b-form-group label="Service">
                        <b-form-checkbox-group :options="product_categories" v-model="form.product_categories"></b-form-checkbox-group>
                    </b-form-group>
